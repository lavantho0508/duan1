 ...
 * @author DEll
 */
public class LoaiHang_JDialog extends javax.swing.JDialog {

    IQLySanPhamService _IQLySanPhamService = (IQLySanPhamService) new QLySanPham_Service();

    /**
     * Creates new form L_Hang_JDialog
     */
    public LoaiHang_JDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public boolean checkNamesProduct(String Names) {
        if (_IQLySanPhamService.findByNames_LoaiHang(Names) == null) {
            return true;
        } else {
            Helper.DialogHelper.alert(this, "Loại Hàng " + Names + " đã tồn tại !");
            return false;
        }
    }

    public LOAI_HANG getForm() {
...
//            _rowLoaiHang = -1;
    ...
    private void setID() {
        List<LOAI_HANG> lst = _IQLySanPhamService.selectAll_LoaiHang();
        if (lst.size() == 0) {
            txt_IDLoaiHang.setText("LH" + 1);
        } else {
            String matam = lst.get(lst.size() - 1).getMALOAIHANG();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Tên Loại Hãng:");

        jLabel2.setText("Mã Loại Hãng:");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setText("Loại hãng");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txt_TenLoaiHang)
                            .addComponent(txt_IDLoaiHang, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (UtilityHelper.checkNullText(txt_IDLoaiHang) && UtilityHelper.checkNullText(txt_TenLoaiHang)) {
            if (UtilityHelper.checkIdHang(txt_IDLoaiHang) && UtilityHelper.checkTenHang(txt_TenLoaiHang)) {
                if (checkIDProduct(txt_IDLoaiHang.getText()) && checkNamesProduct(txt_TenLoaiHang.getText())) {
                    insertLoaiHang();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoaiHang_JDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoaiHang_JDialog dialog = new LoaiHang_JDialog(new javax.swing.JFrame(), true);
