 ...
 * @author DEll
 */
public class Hang_JDialog extends javax.swing.JDialog {

    IQLySanPhamService _IQLySanPhamService = (IQLySanPhamService) new QLySanPham_Service();

    /**
     * Creates new form Hang_JDialog
     */
    public Hang_JDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//            tabs.setSelectedIndex(1);
    ...
    private void setID() {
        ...
        if (lst.size() == 0) {
            ...
            String matam = lst.get(lst.size() - 1).getMAHANG();
            int c = Integer.parseInt(matam.substring(4));
            c++;
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txt_IDHang, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hang_JDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Hang_JDialog dialog = new Hang_JDialog(new javax.swing.JFrame(), true);
