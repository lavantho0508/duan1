 ...
 * @author DEll
 */
public class LoaiKinh_JDialog extends javax.swing.JDialog {

    IQLySanPhamService _IQLySanPhamService = (IQLySanPhamService) new QLySanPham_Service();

    /**
     * Creates new form LoaiKinh_JDialog
     */
    public LoaiKinh_JDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public boolean checkNamesProduct(String Names) {
        if (_IQLySanPhamService.findByNames_LoaiKinh(Names) == null) {
            return true;
        } else {
            Helper.DialogHelper.alert(this, "Loại Kính " + Names + " đã tồn tại !");
            return false;
        }
    }

    public LOAI_KINH getForm() {
        LOAI_KINH loai_kinh = new LOAI_KINH();
        loai_kinh.setMALOAI(txt_IDLoaiKinh.getText());
        loai_kinh.setLOAIKINH(txt_TenLoaiKinh.getText());
...
//            _rowGioiTinh = -1;
    ...
    private void setID() {
        List<LOAI_KINH> lst = _IQLySanPhamService.selectAll_LoaiKinh();
        if (lst.size() == 0) {
            txt_IDLoaiKinh.setText("LK" + 1);
        } else {
            String matam = lst.get(lst.size() - 1).getMALOAI();
    ...
    private void initComponents() {
        ...
        txt_TenLoaiKinh = new javax.swing.JTextField();
        ...
        jLabel3.setText("Loại kính:");

        jLabel2.setText("Mã loại kính");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setText("Loại kính");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txt_IDLoaiKinh)
                    .addComponent(txt_TenLoaiKinh))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txt_TenLoaiKinh, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (UtilityHelper.checkNullText(txt_IDLoaiKinh) && UtilityHelper.checkNullText(txt_TenLoaiKinh)) {
            if (UtilityHelper.checkIdHang(txt_IDLoaiKinh) && UtilityHelper.checkTenHang(txt_TenLoaiKinh)) {
                if (checkIDProduct(txt_IDLoaiKinh.getText()) && checkNamesProduct(txt_TenLoaiKinh.getText())) {
                    insertLoaiKinh();
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoaiKinh_JDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoaiKinh_JDialog dialog = new LoaiKinh_JDialog(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField txt_TenLoaiKinh;
